...
export default function App() {
    ...
    const [currentPlayer, setCurrentPlayer] = React.useState<PlayerIdentifier>({
        name: 'wheaty',
        tag: '420'
    });
    ...
    const peakTierIdx =
        profileAny.peak_tier_index ??
        profileAny.peak_tier ??
        27;

    const currentTierIdx =
        profileAny.current_tier_index ??
        profileAny.currenttier ??
        27;

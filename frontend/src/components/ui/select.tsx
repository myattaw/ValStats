...
function SelectContent({
                           ...
                           compact = false,
                           ...props
                       }: React.ComponentProps<typeof SelectPrimitive.Content> & { compact?: boolean }) {
     return (
         <SelectPrimitive.Portal>
             <SelectPrimitive.Content
                 ...
                 position={position}
                 className={cn(
                     "bg-popover text-popover-foreground relative z-50 min-w-[8rem] overflow-hidden rounded-md border shadow-lg ring-1 ring-black/5 dark:ring-white/5",
             ...
             >
                <SelectPrimitive.Viewport
                    ...
                    className={cn(
                        ...
                        "[&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-gray-600 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb:hover]:bg-gray-500"
                    )}
                >
                    {children}
                </SelectPrimitive.Viewport>
